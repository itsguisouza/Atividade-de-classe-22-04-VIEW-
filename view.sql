...
('Tênis de corrida', 100, 10, FALSE, 199.99),
('Camiseta esportiva', 50, 5, FALSE, 49.90),
('Notebook', 30, 2, FALSE, 2999.00),
('Leite', 200, 20, TRUE, 4.50),
('Café', 150, 15, FALSE, 12.99);
...
('Arroz Integral', 200, 20, FALSE, 5.99, '2024-08-31'),
('Leite Desnatado', 150, 15, TRUE, 3.50, '2024-07-15'),
('Pão Integral', 100, 10, FALSE, 2.99, '2024-06-30');
